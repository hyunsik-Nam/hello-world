...
import nhs.action.NhsAction;

@WebServlet(urlPatterns = {"*.do"},
      initParams = {@WebInitParam(name="properties",
      value = "nhs.properties")})
public class NhsController extends HttpServlet {
   private static final long serialVersionUID = 1L;
   private Properties pr = new Properties();
   private NhsAction action = new NhsAction();
   private Class[] paramType = new Class[]
         {HttpServletRequest.class, HttpServletResponse.class};
    public NhsController() {
        super();
    }
    @Override
