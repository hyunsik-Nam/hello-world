...
<h3>forEach태그를 이용하여 1부터 100까지의 짝수 합 구하기</h3>
<c:forEach var="i" begin="2" end="100" step="2">
	<c:set var="sum" value="${sum+i }"/>
</c:forEach>
1부터 100까지의 짝수 합 : ${sum}<br>

<h3>forEach태그를 이용하여 1부터 100까지의 홀수 합 구하기</h3>
...
<h3>forEach 태그를 이용하여 배열 객체의 짝수 인덱스 요소만 출력</h3>
<c:forEach var="a" items="${arr}" varStatus="stat" step="2">
	arr[${stat.index}]=${a}<br>
</c:forEach>

<h3>forEach 태그를 이용하여 배열 객체의 홀수 인덱스 요소만 출력</h3>
